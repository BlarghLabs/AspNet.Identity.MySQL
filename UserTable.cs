  ...
  public class UserTable<TUser>
    ...
    public TUser GetUserById(string userId) {
      ...
      if (rows != null && rows.Count == 1) {
        ...
        user.EmailConfirmed = ParseForBool(row["EmailConfirmed"]);
    ...
    public bool ParseForBool(string s) {
      return string.IsNullOrEmpty(s) ? false : ((s == "1") || (s.ToLower() == "true"));
    }

    /// <summary>
    /// Returns a list of all TUser 
    /// </summary>
    /// <returns></returns>
    ...
    public int Update(TUser user) {
      ...
      var result = _database.Execute(commandText, parameters);
